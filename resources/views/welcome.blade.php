        ...
        <div><!-- TITLE PART START -->
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="title">
                            <span class="main-title">Сайт Первой логистической компании в разработке</span>
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-12 col-md-10 col-lg-7 col-xl-7">
                        <div class="home1-counter-box">
                            ...
                            <h2 class="expired-text hidden">Скоро открытие</h2>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 col-xl-6  text-center">
                            <div class="subscribe-form text-center">
                                <form action="mailto:info@gkrsh.ru" class="form-inline mx-auto">
                                    <input type="hidden" name="subject" value="Запрос%20с%20сайта">
                                    <input type="hidden" name="message" value="Здравствуйте">
                                    <br>
